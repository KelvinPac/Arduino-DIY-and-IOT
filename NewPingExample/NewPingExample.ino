  ...
  int speed = 255; //  Motor speed. (PWM) maximum value is 255, Minimum is 40-50 but varies depending on power factor;
  
  int objectDistance = 20; // Adjust accordingly (in centimeters). Maximum should be less than @MAX_DISTANCE.
